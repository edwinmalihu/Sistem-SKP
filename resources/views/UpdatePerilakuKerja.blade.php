  ...
  <div class="page-content container-fluid">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <br>
    <form action="/update-perilaku/{{$skp->id_data_skp}}" method="post">
    @method('patch')
    @csrf
        <table border="1" class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td>=</td>
                    <td><input type="text" class="form-control" name="n_op" id="n_op" value="{{$perilaku->n_op}}"/></td>
                    <td><input type="text" class="form-control" name="s_op" id="s_op" value="{{$perilaku->s_op}}"></td>
                </tr>
                <tr>
                    <td>Integritas</td>
                    <td>=</td>
                    <td><input type="text" class="form-control" name="n_i" id="n_i" value="{{$perilaku->n_i}}"/></td>
                    <td><input type="text" class="form-control" name="s_i" id="s_i" value="{{$perilaku->s_i}}"></td>
                </tr>
                <tr>
                    <td>Komitmen</td>
                    <td>=</td>
                    <td><input type="text" class="form-control" name="n_k" id="n_k" value="{{$perilaku->n_k}}"/></td>
                    <td><input type="text" class="form-control" name="s_k" id="s_k" value="{{$perilaku->s_k}}"></td>
                </tr>
                <tr>
                    <td>Disiplin</td>
                    <td>=</td>
                    <td><input type="text" class="form-control" name="n_d" id="n_d" value="{{$perilaku->n_d}}"/></td>
                    <td><input type="text" class="form-control" name="s_d" id="s_d" value="{{$perilaku->s_d}}"></td>
                </tr>
                <tr>
                    <td>Kerjasama</td>
                    <td>=</td>
                    <td><input type="text" class="form-control" name="n_ks" id="n_ks" value="{{$perilaku->n_ks}}"/></td>
                    <td><input type="text" class="form-control" name="s_ks" id="s_ks" value="{{$perilaku->s_ks}}"></td>
                </tr>
                <tr>
                    <td>Kepemimpinan</td>
                    <td>=</td>
                    <td><input type="text" class="form-control" name="n_kp" id="n_kp" value="{{$perilaku->n_kp}}"/></td>
                    <td><input type="text" class="form-control" name="s_kp" id="s_kp" value="{{$perilaku->s_kp}}"></td>
                </tr>
                <tr>
                    <td>Jumlah</td>
                    <td>=</td>
                    <td><input type="text" class="form-control" name="n_jml" id="n_jml" value="{{$perilaku->n_jml}}"/></td>
                    <td><input type="hidden" class="form-control" name="s_jml" value="-"></td>
                </tr>
                <tr>
                    <td>Nilai Rata-rata</td>
                    <td>=</td>
                    <td><input type="text" class="form-control" name="n_rr" id="n_rr" value="{{$perilaku->n_rr}}"/></td>
                    <td><input type="text" class="form-control" name="s_rr" id="s_rr" value="{{$perilaku->s_rr}}"></td>
                </tr>
            </tr>
        </table>
            <br>
